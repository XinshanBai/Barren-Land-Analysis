...
import static com.target.interview.barren_land_analysis_multithread.BarrenLandAnalysisMultiThreadV3.connectedThreadList;
...
public class MultiStartingPointThreadV3 extends Thread {

	private int customId;
	private int coveredArea;
	private Point startingPoint;

	public MultiStartingPointThreadV3(int customId, Point startingPoint) {
		super();
